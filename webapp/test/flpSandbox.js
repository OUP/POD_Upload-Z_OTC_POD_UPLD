        ...
        ClientSideTargetResolution: {
          adapter: {
            config: {
              inbounds: {
                "PODUpload-display": {
                  semanticObject: "PODUpload",
                  action: "display",
                  description: "POD Upload application.",
                  title: "POD Upload",
                  signature: {
                    parameters: {},
                  },
                  resolutionResult: {
                    ...
                    additionalInformation:
                      "SAPUI5.Component=oup.otc.zotcpodupld",
                    url: sap.ui.require.toUrl("oup/otc/zotcpodupld"),
                  },
                },
              },
            },
